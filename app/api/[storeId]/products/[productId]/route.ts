...
export async function GET(
  ...
  try {
    ...
    return new NextResponse("Internel Product_GET error");
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    console.log("Single Product_PATCH", error);
    return new NextResponse("Single  Product Update Error", { status: 500 });
  }
}
